...
const HashTagList = () => {
  ...
  return (
    <ul className="flex flex-col items-center justify-center w-full h-full min-h-10 gap-1.5 rounded-md p-2 bg-primary-50 text-slate-200 text-sm sm:text-base">
