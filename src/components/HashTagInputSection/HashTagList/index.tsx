...
const HashTagList = () => {
  ...
  return (
    <ul className="flex select-none cursor-default flex-col items-center justify-center w-full h-full min-h-10 gap-1.5 rounded-md p-2 bg-secondary-300 text-slate-200 text-sm sm:text-base">
